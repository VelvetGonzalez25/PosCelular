		...
		if(isset($_POST["nuevaVenta"])){
			...
			if($respuesta == "ok"){
				...
				if(isset($_POST["impresion"])){
					...
					$printer -> text("CELULAR CENTER"."\n");//Nombre de la empresa

					$printer -> text("NIT: 36853461 "."\n");//Nit de la empresa

					$printer -> text("Dirección: Av. Ismael Arriaza 0 00 Zona 2 Sanarate, El Progreso "."\n");//Dirección de la empresa

					$printer -> text("Teléfono: 48009050"."\n");//Teléfono de la empresa
					...
					foreach ($listaProductos as $key => $value) {
						...
						$printer->text("Q ".number_format($value["precio"],2)." Und x ".$value["cantidad"]." = Q ".number_format($value["total"],2)."\n");
					...
					$printer->text("TOTAL: Q ".number_format($_POST["totalVenta"],2)."\n"); //ahora va el total
		...
		if(isset($_GET["reporte"])){
			...
			echo utf8_decode("<table border='0'> 
					...
					foreach ($ventas as $row => $item) {
						...
						// Obtener el cliente y vendedor, y verificar si existen
						...
						echo "<td style='border:1px solid #eee;'>".utf8_encode($item["codigo"])."</td>";
					
						// Mostrar nombre del cliente, si existe
						if (isset($cliente["nombre"])) {
							echo "<td style='border:1px solid #eee;'>".utf8_encode($cliente["nombre"])."</td>";
						} else {
							echo "<td style='border:1px solid #eee;'>N/A</td>";  // Si el cliente no existe
						}
					
						// Mostrar nombre del vendedor, si existe
						if (isset($vendedor["nombre"])) {
							echo "<td style='border:1px solid #eee;'>".utf8_encode($vendedor["nombre"])."</td>";
						} else {
							echo "<td style='border:1px solid #eee;'>N/A</td>";  // Si el vendedor no existe
						}
						...
						if (!empty($productos)) {
							foreach ($productos as $key => $valueProductos) {
								echo utf8_encode($valueProductos["cantidad"])."<br>";  // Cantidad de productos
							}
						} else {
						...
						// Mostrar las descripciones de los productos
						echo "<td style='border:1px solid #eee;'>";
						if (!empty($productos)) {
							foreach ($productos as $key => $valueProductos) {
								echo utf8_encode($valueProductos["descripcion"])."<br>";  // Descripción del producto
							}
						} else {
							echo "No hay descripciones";
						}
						echo "</td>";
